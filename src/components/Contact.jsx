      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <p className="text-slate-600 dark:text-slate-400 font-light leading-relaxed">
            If you have a design requirement, static templates to slice, React components to build, or need support with Kajabi/Webflow, drop a message!
          </p>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="mailto:riyadogra162001@gmail.com" className="text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-violet-500 dark:hover:text-violet-400 transition-colors">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="tel:+918968728161" className="text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-violet-500 dark:hover:text-violet-400 transition-colors">
                  +91 8968728161
                </a>
              </div>
            </div>
